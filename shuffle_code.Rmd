...
## Definicion de el maso como un Data frame
...
Esto expliquelo usted jhonatan no se que decir ahi xd 
...
Esta funcion se encarga de darle a cada jugador dos cartas y repartir las cartas de la mesa, esto lo hara emulanod cada juagador como un data frame de dos cartas y lo agregara a un vector, que asu vez sera agregado a una lista para que se encuentren los jugadores y el data frame de las cartas de la mesa 
